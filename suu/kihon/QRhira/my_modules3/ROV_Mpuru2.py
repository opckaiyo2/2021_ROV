	...
	try:
		...
		while True:
			...
			if x == 0:
				...
				motor.forward_rotation(15, 0, 11) #-7 reverse
				motor.forward_rotation(14, 0, 10)
				motor.forward_rotation(11, 0, -7)
				motor.forward_rotation(10, 0, -7)
				...
				#back
				motor.forward_rotation(15, 0, -5) #-7 reverse
				motor.forward_rotation(14, 0, -6)
				motor.forward_rotation(11, 0, 10)
				motor.forward_rotation(10, 0, 9)
				
				motor.forward_rotation(13, 0, 0) #motor 2
				motor.forward_rotation(12, 0, 0)
			elif x == 3:
				#rise
				motor.forward_rotation(13, 0, -7) #motor 2
				motor.forward_rotation(12, 0, -7)
				...
				#moguru
				motor.forward_rotation(13, 0, 15) #motor 2
				motor.forward_rotation(12, 0, 9)
