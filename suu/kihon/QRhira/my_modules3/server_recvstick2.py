        ...
        while True:
            ...
            while True:
                ...
                if d[0] >= m_threshold and d[0]  <= p_threshold and d[1] <= m_threshold:
                    ...
                    motor.forward_rotation(15, 0, (offs*duty)+11+2+8) #-7 reverse
                    motor.forward_rotation(14, 0, (offs*duty)+10+2+8)
                    motor.forward_rotation(11, 0, (-1*offs*duty)-7-8)
                    motor.forward_rotation(10, 0, (-1*offs*duty)-7-8)
                    ...
                    motor.forward_rotation(15, 0, (-1*offs*duty)-5-8) #-7 reverse
                    motor.forward_rotation(14, 0, (-1*offs*duty)-6-8)
                    motor.forward_rotation(11, 0, (offs*duty)+10+8)
                    motor.forward_rotation(10, 0, (offs*duty)+10+8)
