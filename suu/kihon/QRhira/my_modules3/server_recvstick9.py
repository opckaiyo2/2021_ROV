        ...
        while True:
            ...
            while True:
                ...
                if d[0] >= m_threshold and d[0]  <= p_threshold and d[1] <= m_threshold:
                    ...
                    motor.forward_rotation(15, 0, 11+(offs+10+10)+3*duty)#0
                    motor.forward_rotation(14, 0, 10+(offs+10+10)*duty)  #1
                    motor.forward_rotation(11, 0, -1*(offs)*duty-7) #4
                    motor.forward_rotation(10, 0, -1*(offs)*duty-7) #5
                    ...
                    motor.forward_rotation(15, 0, -1*(offs+5)*duty-5) #-7 reverse
                    motor.forward_rotation(14, 0, -1*(offs+5)*duty-6)
                    motor.forward_rotation(11, 0, (offs+1)*duty+10)
                    motor.forward_rotation(10, 0, (offs+1)*duty+10)
