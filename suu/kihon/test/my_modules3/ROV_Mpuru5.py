...
class ROV_Motor:
	def __init__(self):
		...
		self.pca.set_pwm_freq(67) #72Hz
		#setting
		self.POWER       = 0.5
		self.standard    = 438  #duty 9.8% motor stoped
	...
	try:
		...
		while True:
			...
			if x == 0:
				...
				motor.forward_rotation(15, 0, 11+offs) #-7 reverse
				motor.forward_rotation(14, 0, 10+offs)
				motor.forward_rotation(11, 0, -1*offs-7)
				motor.forward_rotation(10, 0, -1*offs-7)
				...
				#back
				motor.forward_rotation(15, 0, -1*offs-5) #-7 reverse
				motor.forward_rotation(14, 0, -1*offs-6)
				motor.forward_rotation(11, 0, 10+offs)
				motor.forward_rotation(10, 0, 10+offs)
				
				motor.forward_rotation(13, 0, 0) #motor 2
				motor.forward_rotation(12, 0, 0)
			elif x == 3:
				#rise
				motor.forward_rotation(13, 0, -1*offs-7) #motor 2
				motor.forward_rotation(12, 0, -1*offs-7)
				...
				#moguru
				motor.forward_rotation(13, 0, 15+offs) #motor 2
				motor.forward_rotation(12, 0, 10+offs)
