...
class ROV_Motor:
	def __init__(self):
		...
		#setting
		self.POWER       = 0.5
		self.standard    = 451  #duty 9.8% motor stoped
	...
	try:
		...
		while True:
			...
			if x == 0:
				...
				motor.forward_rotation(1, duty, 0)
				motor.forward_rotation(2, duty, 0)
				motor.forward_rotation(3, duty, 0)
				motor.forward_rotation(4, duty, 0)
				motor.forward_rotation(5, duty, 0)
			elif x == 1:
				#motor.forward_rotation(0, duty, offset['pin0'])
				motor.forward_rotation(0, duty, 9)
				motor.forward_rotation(1, duty, 9)
				motor.forward_rotation(2, duty, 14)
				motor.forward_rotation(3, duty, 9)
				motor.forward_rotation(4, duty, 9)
				motor.forward_rotation(5, duty, 9)
