        ...
        while True:
            ...
            while True:
                ...
                if d[0] >= m_threshold and d[0]  <= p_threshold and d[1] <= m_threshold:
                    ...
                    motor.forward_rotation(15, 0, 7+(offs-18+15)*duty)#0 右前
                    motor.forward_rotation(14, 0, 7+(offs-20+15)*duty)  #1 右後
                    motor.forward_rotation(11, 0, -1*(offs+30+30-30)*duty-7)      #4 左前
                    motor.forward_rotation(10, 0, -1*(offs+28+30-30)*duty-7)      #5 左後
                    ...
                    motor.forward_rotation(15, 0, -1*(offs-7)*duty-5) #0 右前　
                    motor.forward_rotation(14, 0, -1*(offs-7)*duty-6) #1 右後
                    ...
                    motor.forward_rotation(15, 0, -1*(offs-20)*duty-5)      #0 右前
                    motor.forward_rotation(14, 0, -1*(offs-20)*duty-6)      #1 右後
                    motor.forward_rotation(11, 0, -1*(offs-20)*duty-7)      #4 左前
                    motor.forward_rotation(10, 0, -1*(offs-20)*duty-7)      #5 左後
                    ...
                    motor.forward_rotation(15, 0, 11+(offs-20)*duty)        #0 右前
                    motor.forward_rotation(14, 0, 10+(offs-20)*duty)        #1 右後
                    motor.forward_rotation(11, 0, 10+(offs-20)*duty)        #4 左前
                    motor.forward_rotation(10, 0, 10+(offs-20)*duty)        #5 左後
