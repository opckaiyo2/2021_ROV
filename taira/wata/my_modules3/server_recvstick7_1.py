        ...
        while True:
            ...
            while True:
                ...
                if d[0] >= m_threshold and d[0]  <= p_threshold and d[1] <= m_threshold:
                    duty=-1*d[1]
                    motor.forward_rotation(15, 0, 8+offs*duty)
                    motor.forward_rotation(14, 0, 7+offs*duty)
                    motor.forward_rotation(11, 0, -1*offs*duty-10)
                    motor.forward_rotation(10, 0, -1*offs*duty-10)
                    ...
                    motor.forward_rotation(15, 0, -1*offs*duty-8) #-7 reverse
                    motor.forward_rotation(14, 0, -1*offs*duty-10)
                    motor.forward_rotation(11, 0, offs*duty+10)
                    motor.forward_rotation(10, 0, offs*duty+8)
                    ...
                    #print('duty:',duty)
                    #print(10 + offs*duty)
                    motor.forward_rotation(15, 0, -1*offs*duty-7) #-7 reverse
                    motor.forward_rotation(14, 0,offs*duty+8)
                    motor.forward_rotation(11, 0, -1*offs*duty-9)
                    motor.forward_rotation(10, 0, offs*duty+7)
                ...
                if sensui_autofg==True:
                    ...
                    if d[2]>= m_threshold and d[2] <= p_threshold and d[3]  <= m_threshold:
                        duty=-1*d[3]
                        #print('duty:',duty)
                        motor.forward_rotation(13, 0, -1*offs2*duty-10) #motor
                        motor.forward_rotation(12, 0, -1*offs2*duty-10)
                        print('motor.Hujyou')
                        print(d[3])
                        ...
                        duty=d[3]
                        #print('duty:',duty)                    
                        motor.forward_rotation(13, 0, 12+offs2*duty)#motor 2
                        motor.forward_rotation(12, 0, 8+offs2*duty)
